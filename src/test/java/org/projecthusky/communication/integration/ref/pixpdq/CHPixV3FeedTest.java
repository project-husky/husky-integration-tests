 ...
 *
 */
package org.projecthusky.communication.integration.ref.pixpdq;
...
class CHPixV3FeedTest {
	...
	@Value(value = "${test.pixf.uri:https://ehealthsuisse.ihe-europe.net/PAMSimulator-ejb/PIXManager_Service/PIXManager_PortType}")
	...
	final String localId = "waldspital-Id-";
	...
	void feedTest() throws Exception {
		...
		identifier.setValue(localId+UUID.randomUUID().toString());
